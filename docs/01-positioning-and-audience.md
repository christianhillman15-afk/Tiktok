...
> **What this doc is.** The foundation every other doc in this playbook is built on. Before you script a single video, read this. It defines exactly *who* we sell to, *what* we lead with, *why they buy*, and *the words we put in their mouth*. If a piece of content doesn't map to the positioning, the ICP, and the pain language here — don't post it.
...
## 2. The Websites-First Wedge (why we lead with sites, not marketing)

We could sell marketing retainers directly. We don't. **We lead with the website on purpose** — it's a strategic wedge, not our main profit center.

### The three reasons we lead with the build

**1. It's the lowest-friction, highest-trust first purchase a skeptical stranger will make.**
A website is a *concrete, visible outcome* — "a site that looks legit and captures the 76% of near-me searchers who act within 24 hours." "Marketing" is an abstract promise a burned owner won't send a deposit for. The site is something they can see, show off, and understand.

**2. It's the single most demonstrable service on short-form video.**
Teardowns and before/after reveals *are* website content. You literally screen-record the thing you sell. Marketing results are slow and invisible; a redesign glow-up is instant and save-worthy. **The service that's easiest to demo is the service that generates the lead.**

**3. $0-down monthly Website-as-a-Service kills the upfront-cash objection.**
Cold TikTok buyers won't wire $4k to a stranger. "$0 down, $199/mo, cancel anytime, you own it" collapses the sticker shock that murders cold social deals.

### The wedge economics (know this cold)

| | The Wedge (the site) | The Profit Center (the retainer) |
|---|---|---|
| **Role** | Foot-in-the-door, win the client, prove competence | The actual recurring business |
| **Margin** | Deliberately near-breakeven | Where the money is |
| **Offer** | Starter "Get Found" / Growth "Get Leads" build | Growth Partner Retainer (SEO / Ads / content) |
| **When sold** | On the discovery call | Month 2–3, once the site is live and producing wins |

We price the build low *on purpose* to win trust, then ascend proven clients into $1,500–$3,500/mo Growth Partner retainers. **The site is the wedge; the retainer is the business.** (Full pricing in the Offer Ladder doc.)

> **The relevance battle, not the price battle.** Research is blunt here: cost is no longer the top reason owners skip a website (only ~16%, down from 26% in 2018). The real #1 is *"not relevant to my industry"* (~34%). So we do **not** lead with "sites are cheap now." We lead with **"you're invisible when your customers look for you."** We're fighting perceived relevance and priority — not budget.
...
**Red light (pass or park):**
- Pure ecommerce / dropshipping / national SaaS
- Enterprise with procurement and an in-house marketing team
...
Med-spas, dentists, and restaurants are **adjacent expansion verticals**, not the starting point. Expand into them **one vertical per content series** only after the home-service engine is producing. Starting broad kills lead quality.

---

## 4. The ICP's Core Pains (say these back to them)

These are the six pains that make an owner stop scrolling. Every teardown, hook, and DM should touch at least one. Note: **none of these is "I want a modern website."** They're all fear of losing customers or looking bad.

1. **Invisible when it matters.** A referral or a "near me" searcher Googles them at 9pm and finds nothing, a thin Facebook page, or a site broken on mobile — and the ready-to-buy customer bounces to a competitor.
2. **Silently leaking high-intent jobs.** 76% of near-me searchers call or visit within 24 hours; an absent/ugly site hands those exact calls to whoever ranks above them.
3. **Not looking legit / embarrassment.** They dread handing out their URL because a dated site signals a neglected business (75% judge credibility on the website; first impressions form in ~50ms).
4. **Time-poor and burned by DIY.** Tried Wix themselves, sank ~40 hours, it's still not done and still doesn't get found — and they can't afford to be pulled off the tools.
5. **Word of mouth stalls on Google.** The friend they were referred to searches the name, finds nothing convincing, and the warm referral dies.
6. **Skeptical of agencies + sticker shock.** They fear getting upsold in jargon they don't understand or locked into a predatory contract.

---

## 5. Exact Pain-Point Language to Mirror (swipe file)

Talk **entirely in the owner's language** — calls, booked jobs, deposits, "looking legit." Never "responsive CMS / UX / SEO stack." Copy these into hooks, captions, and DMs.

### The flagship reframe — use it for every vertical
...
- "When someone Googles you at 9pm, what shows up?"
- "You're invisible right when a customer's ready to buy."
- "Your competitor isn't better than you — they just show up first."
- "This is costing you calls you never even knew you missed."
- "It doesn't make you *look* legit."
- "You built your business on rented land."
- "Word of mouth is amazing — but it ends on Google."
- "What's one new customer worth to you?"
- "A lead machine that books jobs while you sleep."
- "Your phone should be ringing off this, not that Facebook page."

### Say this / Never say this

| Say this (owner language) | Never say this (jargon that signals "I'll get upsold") |
|---|---|
| "shows up when someone Googles you" | "SEO stack / search visibility optimization" |
| "the phone rings / more calls" | "increased conversion rate" |
| "tap-to-call button" | "click-to-call CTA above the fold" |
| "works on a phone" | "mobile-responsive / responsive breakpoints" |
| "looks legit" | "modern, professional design language" |
| "takes a booking at 9pm" | "integrated scheduling module" |
| "you own it" | "self-hosted headless CMS" |
| "$199 a month, we handle everything" | "flexible monthly retainer structure" |

### The one-customer money frame (for price talk)

> **"What's one new customer worth to you over a year? Two grand? This site costs less than that — and it only has to bring you ONE. Everything after that is profit."**
...
## 6. The Objection List + Rebuttals

Every objection below has a **content asset** attached (see Content Pillar 3: Objection-Busting & Plain-Language Education). Owners literally type these phrases into search — each rebuttal is an evergreen video.

| Objection | What they *really* mean | The reframe (in their language) |
|---|---|---|
| **"I don't need a website / it's not really relevant to my industry"** | *This is the real #1 (~34%).* "Nobody in my trade uses a website to find me." | "Maybe *you* don't need one — but your customer does. 97% of people search online for local services, and 76% of 'near me' searchers call within 24 hours. You not having a site doesn't stop the search — it just sends that call to your competitor." |
| **"It's too expensive"** | Sticker shock / fear of a big lump sum | One-customer math + monthly option: "What's one job worth — $2,000? This only has to bring you one. And it's $0 down, $199/month, cancel anytime. That's a coffee a day for a machine that books jobs while you sleep." |
| **"I have a Facebook page"** | "I already have an online presence, isn't that enough?" | "A Facebook page is a house built on rented land. You don't own it — Meta can restrict it overnight, only ~16% of your followers see your posts, it barely shows up on Google, and it can't book a job or take a deposit at 9pm. A website is land you actually own." |
| **"I get all my business by word of mouth"** | *(Do NOT attack this — it's their pride and it's real.)* | "Word of mouth is the best thing you've got — keep it. But here's what happens now: the second someone refers you, their friend Googles your name. If nothing convincing shows up, you just lost a customer you'd already earned. A site doesn't replace word of mouth — it *closes* it." |
| **"I tried Wix / built it myself"** | "I already spent time on this and it half-exists" | "You didn't fail at Wix. You spent 40 hours on something that still doesn't show up on Google — time you should've been on the tools running your business. Your time's worth more than that. We build it done-for-you in 7 days." |
| **"I don't have time"** | Time-poor; fears a project that eats his week | This is a reason to *buy*, not wait: "That's exactly why you hand it off. 10-minute intake call, we handle the copy, the photos, the launch — all of it. You keep working; you just start showing up online." |
| **"I'm already busy / booked out"** | No felt pain right now | "Perfect time — build it when you're strong, not when you're desperate. Slow season always comes, and when it does you want the phone already ringing. Plus a real site lets you *raise your prices* and look like the premium option." |
...
## 7. Buying Triggers (emotional + financial)

Owners **rarely buy from a rational cost argument.** They buy off an emotional trigger + event, paired with a low-risk offer. Make content aimed at owners *in these exact moments* — that's when the wallet opens and the DM comes.

### Emotional triggers (and the content aimed at each)

| Trigger | The moment | Content / hook to aim at it |
|---|---|---|
| **Competitor outranking them** | They Googled their own service and a rival showed up first | "Your competitor isn't better than you. They just show up first on Google." |
| **Embarrassment handing out the URL** | Gave someone their link or Googled themselves and cringed | "If you're embarrassed to hand out your website, you don't have a website problem — you have a first-impression problem. People decide in 50 milliseconds." |
...
| Trigger | The moment | Angle to use |
|---|---|---|
| **A specific lost deal** | Watched a ready customer go elsewhere | "You didn't lose that job on price. You lost it before they even called you." |
| **Slow season hitting** | Phone went quiet | "When word of mouth dries up, Google is the only thing still working for you at 3am." |
| **Just hired a tech / bought a truck** | New overhead needs filling | "You added a truck — now you need the jobs to fill it. That doesn't come from Facebook." |
| **Raising prices / going premium** | Wants to charge more | "You can't charge premium prices with a $200 nephew website. The site has to match the price." |
| **Seasonal ramp** | Before the heatwave / spring / storm season | "The heatwave is coming. Do you want to be found the day everyone's AC dies — or invisible?" |
