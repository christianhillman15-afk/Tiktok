...
Most agencies try to sell "marketing" to skeptical local business owners on social media. It doesn't work, because "marketing" is abstract, expensive-sounding, and impossible to prove to a stranger scrolling their phone.

We do the opposite. We lead with **websites** because a website is the single easiest, highest-trust, most *demonstrable* thing you can sell a nervous owner from a cold TikTok video. You can literally show it — teardowns, before/afters, "watch me fix this in 60 seconds." That visual proof is exactly the content the algorithm rewards *and* exactly what makes a plumber think "that's my site." We price the build near breakeven to win the client and prove we're competent — then we ascend them into local SEO, Google Ads, and content retainers, which is where the money actually lives.

**Sell the wedge. Keep the retainer.**

---

## The core thesis (read this twice)
...
- They **live and die by "near me" search intent.**
- They're the segment **most likely to be invisible** when a ready-to-buy customer looks for them.

*(Med-spas, dentists, and restaurants are secondary verticals to expand into later — one vertical per content series.)*

### The pain we press on
- **Invisible when it matters** — a referral Googles them at 9pm and finds nothing, or a site that's broken on mobile. The ready-to-buy customer bounces to a competitor.
- **Silently leaking high-intent jobs** — 76% of near-me searchers call or visit within 24 hours; an absent/ugly site hands those calls to whoever ranks above them.
- **Not looking legit** — they dread handing out their URL (75% of people judge a business's credibility on its website; a first impression forms in ~50ms).
- **Time-poor and burned by DIY** — tried Wix, sank ~40 hours, still not done, still doesn't get found.
- **Word of mouth stalls on Google** — the warm referral dies when the friend searches the name and finds nothing convincing.
- **Skeptical of agencies** — fear jargon, upsells, and predatory lump-sum contracts.
...
| Rung | What it is | Price | Role |
|---|---|---|---|
| **Free Website Teardown / Audit** | Personalized 2–3 min screen-recorded audit naming 3 conversion-killers | **Free** | The DM magnet — what all content points at |
| **Starter — "Get Found"** | 1–5 pages, mobile-first, click-to-call, GBP setup, 7-day launch | $1,500–$2,500 **or $0 down + $149–$199/mo** | The wedge (near-breakeven) |
| **Growth — "Get Leads"** ⭐ | Starter + 6–10 pages, local SEO pages, booking, CRM + 60s text-back, review funnel | $3,500–$6,000 **or $0 down + $249–$399/mo** | **MOST POPULAR** — the anchor tier |
| **Pro — "Get Scale"** | Growth + 10+ pages, ecommerce, CRO, light retainer included | $7,500–$15,000+ | Price anchor above Growth |
| **Growth Partner Retainer** | Recurring local SEO / Google Ads / content | $1,500–$3,500/mo all-in | **The profit center** |

Lead cold TikTok buyers to the **$0-down monthly** option — it kills sticker shock and 2–3x's revenue per client over the term. Full details in `docs/07-offers-and-pricing.md`.

---

## The funnel in six stages

**Discover** (search-first video) → **Engage** (comment "AUDIT") → **Capture** (DM the keyword → free teardown by email) → **Qualify & Book** (personalized 3-flaw teardown, withhold fixes, send straight to Calendly) → **Close** (structured discovery call, sell the wedge with retainer baked in) → **Follow-up & Ascend** (24h recap, then pitch the retainer in month 2–3).

> ⚠️ **US/UK/EU note:** TikTok's native comment-to-DM automation is **NOT live here.** Tell viewers to **"DM me the word AUDIT"** so ManyChat fires, or DM commenters manually. DMs can't contain clickable links — capture email in-DM and deliver the teardown + booking link **by email.** Full mechanics in `docs/06-lead-funnel-and-dm-templates.md`.

---

## Table of contents — the full playbook

| # | File | What's inside |
|---|---|---|
| 01 | [`docs/01-positioning-and-audience.md`](docs/01-positioning-and-audience.md) | The full positioning, ICP deep-dive, pain points, buying triggers, and brand voice rules — the source of truth every other doc obeys. |
| 02 | [`docs/02-content-pillars-and-formats.md`](docs/02-content-pillars-and-formats.md) | The 5 content pillars (teardowns, before/afters, education, proof, offer/BTS), the hybrid face-cam-over-screen format, and the 70/30 educational-to-offer ratio. |
| 03 | [`docs/03-content-calendar-30-days.md`](docs/03-content-calendar-30-days.md) | A plug-and-play 30-day, 4-posts-per-week calendar mapping every slot to a pillar, hook, and keyword target. |
| 04 | [`docs/04-video-scripts.md`](docs/04-video-scripts.md) | Full copy-paste scripts for each pillar — teardown template, before/after reveal, price-transparency, and case-study formats, hook to CTA. |
| 05 | [`docs/05-hooks-library.md`](docs/05-hooks-library.md) | A swipe file of 3-second hooks and front-loaded search captions engineered for ~70% completion and search ranking. |
| 06 | [`docs/06-lead-funnel-and-dm-templates.md`](docs/06-lead-funnel-and-dm-templates.md) | The end-to-end funnel: ManyChat keyword flows, the 5-beat DM structure, booking nudges, no-show recovery, and follow-up cadence. |
| 07 | [`docs/07-offers-and-pricing.md`](docs/07-offers-and-pricing.md) | The full offer ladder, WaaS math, the guarantee stack, and the wedge-to-retainer ascension script. |
...
## KPIs to watch (and the ones to ignore)

Track what predicts revenue. Review these **weekly**; judge the strategy at **90 days**, not 3 weeks.

| KPI | Why it matters | Rough target |
|---|---|---|
| **Qualified DMs + keyword comments/week** (AUDIT/WEBSITE intent) | The primary top-of-funnel lead signal — not views, not followers | Trending up week over week |
...
| **Posting-cadence adherence** | Consistency trains the algorithm | **4 posts/week, sustained 90 days** |

**Ignore:** follower count and raw view totals. They feel good and pay nothing.

---

*The site is the wedge. The retainer is the business. Now go film 8 teardowns.*
